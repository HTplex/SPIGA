...
CUDA_VISIBLE_DEVICES=1 python ./spiga/demo/app2.py --input  /data/datasets_v2/clip_videos_v3/ --save --noview --outpath /data/datasets_v2/faces_v3/ -x 1:4 &
CUDA_VISIBLE_DEVICES=2 python ./spiga/demo/app2.py --input  /data/datasets_v2/clip_videos_v3/ --save --noview --outpath /data/datasets_v2/faces_v3/ -x 2:4 &
CUDA_VISIBLE_DEVICES=3 python ./spiga/demo/app2.py --input  /data/datasets_v2/clip_videos_v3/ --save --noview --outpath /data/datasets_v2/faces_v3/ -x 3:4 &
"""